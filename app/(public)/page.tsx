  ...
  return (
    <section className="w-full h-screen overflow-hidden flex items-center bg-[url('/home-bg.png')] bg-no-repeat bg-full-screen bg-center-center relative">
      <div className="absolute top-[14rem] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[48rem] text-center z-20">
        ...
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-[.08rem] text-[.85rem] font-semibold leading-6 text-white inline-block w-[9.5rem] h-[3.15rem]">
      ...
      <div className="absolute top-[29.25rem] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className='w-[40rem] h-[40rem] flex items-center justify-center animate-float'>
          <ThreeDModel
