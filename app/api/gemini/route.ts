...
import { LLMClient, ResponseDto } from '../web-api-client';
...
export async function POST(req: NextRequest) {
    ...
    const apiKey_1 = process.env.GOOGLE_GEMINI_API_KEY_1;
    const apiKey_2 = process.env.GOOGLE_GEMINI_API_KEY_2;

    const genAI_1 = new GoogleGenerativeAI(apiKey_1);
    const genAI_2 = new GoogleGenerativeAI(apiKey_2);
